...
export default function AdminTasksPage() {
    ...
    return (
        <RootLayout>
            ...
            >
                {/* 🔹 Header с кнопкой — анимация появления */}
                <motion.div
                ...
                >
                    <Card>
                        ...
                        <CardContent>
                            {/* 🔹 Лоадер внутри карточки (пагинация/фильтры) */}
                            {isLoading ? (
                                <motion.div
                                    initial={{opacity: 0}}
                                    animate={{opacity: 1}}
                                ...
                                // 🔹 Таблица с анимацией при изменении данных
                                <motion.div
                                    key={`${page}-${titleFilter}-${selectedDifficulties.join(',')}-${selectedTags.join(',')}`}
                                    initial={{opacity: 0.8}}
                                    animate={{opacity: 1}}
